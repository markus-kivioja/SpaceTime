...
#filename = '../F2_monopole/spinor_vtks/180.004281.vtk'
#filename = '../F2_monopole/spinor_vtks/181.004304.vtk'
filename = '../F2_monopole/spinor_vtks/184.004375.vtk'
...
def draw_xz(vec):
    ...
    for x_idx in range(x_ignore_width, BLOCK_COUNT_X - x_ignore_width):
