...
std::array<double, 2> BqDurations = { 100.0 };
std::array<RampType, 2> BqTypes = { RampType::CONSTANT };

//// Bias ////
std::array<double3, 3> Bbs = { make_double3(0, 0, 0.205), make_double3(0, 0, 0) };
std::array<double, 3> BbDurations = { 0.1, 100 };
std::array<RampType, 3> BbTypes = { RampType::CONSTANT, RampType::CONSTANT };
