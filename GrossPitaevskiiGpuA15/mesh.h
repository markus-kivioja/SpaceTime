...
const Vector3 BLOCK_WIDTH = Vector3(4, 4, 4); // dimensions of unit block
const ddouble VOLUME = 1.33333; // volume of body elements
const bool IS_3D = true; // 3-dimensional
void getPositions(Buffer<Vector3> &pos)
{
	pos.resize(VALUES_IN_BLOCK);
	pos[0] = Vector3(3.5, 0.125, 0.75);
	pos[1] = Vector3(2.75, 2.125, 1.5);
	pos[2] = Vector3(3.5, 2.875, 0.75);
	pos[3] = Vector3(2.25, 3.5, 0.125);
	pos[4] = Vector3(0.25, 0.875, 1.5);
	pos[5] = Vector3(0.333333, 2.66667, 0.333333);
	pos[6] = Vector3(1.5, 2.75, 0.875);
	pos[7] = Vector3(2.875, 0.75, 3.5);
	pos[8] = Vector3(0.875, 1.5, 0.25);
	pos[9] = Vector3(3.5, 0.125, 2.25);
	pos[10] = Vector3(1.5, 0.25, 0.875);
	pos[11] = Vector3(3.5, 0.5, 1.5);
	pos[12] = Vector3(1.5, 0.25, 2.125);
	pos[13] = Vector3(0.333333, 2.66667, 2.66667);
	pos[14] = Vector3(0.333333, 0.333333, 0.333333);
	pos[15] = Vector3(0.666667, 0.666667, 0.666667);
	pos[16] = Vector3(3.5, 2.5, 1.5);
	pos[17] = Vector3(2.125, 1.5, 0.25);
	pos[18] = Vector3(2.33333, 2.33333, 0.666667);
	pos[19] = Vector3(2.66667, 0.333333, 0.333333);
	pos[20] = Vector3(2.33333, 0.666667, 0.666667);
	pos[21] = Vector3(2.75, 0.875, 1.5);
	pos[22] = Vector3(0.125, 0.75, 3.5);
	pos[23] = Vector3(0.125, 2.25, 3.5);
	pos[24] = Vector3(1.5, 3.5, 0.5);
	pos[25] = Vector3(0.666667, 2.33333, 0.666667);
	pos[26] = Vector3(0.75, 3.5, 0.125);
	pos[27] = Vector3(0.25, 2.125, 1.5);
	pos[28] = Vector3(2.66667, 2.66667, 0.333333);
	pos[29] = Vector3(3.5, 2.875, 2.25);
	pos[30] = Vector3(2.25, 3.5, 2.875);
	pos[31] = Vector3(2.875, 2.25, 3.5);
	pos[32] = Vector3(2.33333, 0.666667, 2.33333);
	pos[33] = Vector3(2.66667, 0.333333, 2.66667);
	pos[34] = Vector3(0.875, 1.5, 2.75);
	pos[35] = Vector3(0.5, 1.5, 3.5);
	pos[36] = Vector3(2.125, 1.5, 2.75);
	pos[37] = Vector3(1.5, 2.75, 2.125);
	pos[38] = Vector3(0.333333, 0.333333, 2.66667);
	pos[39] = Vector3(0.666667, 0.666667, 2.33333);
	pos[40] = Vector3(0.666667, 2.33333, 2.33333);
	pos[41] = Vector3(2.66667, 2.66667, 2.66667);
	pos[42] = Vector3(2.33333, 2.33333, 2.33333);
	pos[43] = Vector3(1.5, 3.5, 2.5);
	pos[44] = Vector3(2.5, 1.5, 3.5);
	pos[45] = Vector3(0.75, 3.5, 2.875);
}
